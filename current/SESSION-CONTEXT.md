...
## Где мы находимся
**Последнее обновление:** 2026-03-25 19:26
...
**Статус:** задача закрыта — Создан РП-37: Каталог агентов на русском языке - извлечение метаданных всех 75+ агентов, перевод описаний, организация по категориям, JSON-индекс для поиска
