...
## Где мы находимся
**Последнее обновление:** 2026-03-25 19:12
...
**Статус:** задача закрыта — WP-35: VK-телебот как монитор экзокортекса - добавлены уведомления от extractor (session-import, session-tasks, archive-review), реализованы команды бота /status /agents /wp /logs, создан monitor_bot.py и start_monitor.sh
