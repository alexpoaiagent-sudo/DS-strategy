...
## Где мы находимся
**Последнее обновление:** 2026-03-26 21:31
...
**Статус:** задача закрыта — FPF-моделирование PACK-hr: сотрудник, договор, обучение, роль. Создан жёсткий шаблон domain-contract с примерами (сотрудник + смена). Вся FPF-инспекция VK-offee завершена.
