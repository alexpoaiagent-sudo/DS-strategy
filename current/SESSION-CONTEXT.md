...
## Где мы находимся
**Последнее обновление:** 2026-03-27 21:21
...
**Статус:** задача закрыта — Сохранён контекст WP-38: облачный деплой VK-offee бота + RAG API на VPS. Бот v3.1 готов, пользователь идёт выбирать и регистрироваться на хостинге.
