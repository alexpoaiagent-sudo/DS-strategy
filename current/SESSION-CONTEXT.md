...
## Где мы находимся
**Последнее обновление:** 2026-03-26 20:19
...
**Статус:** задача закрыта — РП#30: создан реестр агентов DS-агентства + механизм найма в Ритуале согласования
