...
## Где мы находимся
**Последнее обновление:** 2026-03-27 20:46
...
**Статус:** задача закрыта — Domain-contracts PACK-hr v1.4: закрыт — сотрудник, договор, допуск (текущий: Родион; будущий: модули), роль, модуль обучения (будущий)
