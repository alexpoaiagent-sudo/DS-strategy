...
- [pending] 2026-03-24: Уточнить у Константина последовательность шагов после сдачи архитектурного проекта PARK
  - Контекст: заметка «Парк новые водные» — после обещания Константина закончить проект через несколько дней нужно сверить дальнейшую последовательность с графиком
  - Приоритет: high
  - Домен: Парк
