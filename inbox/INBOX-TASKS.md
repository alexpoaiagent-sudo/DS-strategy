...
- [pending] 2026-03-28: FPF-моделирование PACK-kitchen — FM-уровень (правила блокировки)
  ...
  - Приоритет: medium
  - Что нужно сделать:
    1. KITCHEN.FM.004 — использование просроченного ингредиента/заготовки (блок-правило: просрочен → запрещено)
    2. KITCHEN.FM.005 — партия без ID / маркировки (блок-правило: нет ID → запрещено использовать)
