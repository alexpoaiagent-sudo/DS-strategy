...
4. **Выбор модели:** Объявить модель в Ритуале согласования (protocol-open.md). Таблица ниже.
...
|---|-----|--------|--------|---------|
| 1 | Оптимизация расхода токенов агентов | 2h | pending | 03 мар |
| 2 | Проверка и валидация инфраструктуры экзокортекса | 3h | pending | 04 мар |
| 3 | Развитие архитектуры VK-offee (5 Pack) | 4h | pending | 06 мар |
