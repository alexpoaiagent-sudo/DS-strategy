...
| 20 | Восстановление агентов + система мониторинга | 3h | done | 19 мар |
...
| 7 | Создание PACK-park-development и наполнение документами | 4h | done | — |
| 12 | Интеграция с Saby Presto API | 3-4h | pending | — |
| 19 | Воронка продаж SOTA: анализ транскрипции + разработка алгоритма | 3-4h | done | — |
