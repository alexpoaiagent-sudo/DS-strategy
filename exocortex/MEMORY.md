...
2. **Стартовый экран экзокортекса:** сначала показать русский экран состояния среды и статус «мозга экзокортекса»
3. **Если экран красный** — обычное открытие дня запрещено до сообщения о проблеме и нужном действии
4. **Если экран жёлтый** — продолжать только после явного подтверждения пользователя
5. **WP Gate:** Проверить MEMORY.md → секция "РП текущей недели"
6. **Задача есть в плане?**
...
| 14 | Ремонт кухни: заказ новой мойки модуля для Тургенева | 2h | done | 20 мар |
| 15 | Новые кресла для зала Тургенева | 1.5h | pending | 20 мар |
| 16 | Разрешение на размещение рекламной вывески на Самокиша | 2h | in_progress | 22 мар |
